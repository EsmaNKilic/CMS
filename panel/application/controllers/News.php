...
class News extends CI_Controller{
    ...
    public function save(){ 
        ...
        if($news_type == "image"){
            ...
            $this->form_validation->set_rules("video_url", "Video URL", "required|trim"); //ilk tırnağa nameler, ikinciye başlık adı, üçüncü ise kurallar, dördüncü açacaksak array olur.
