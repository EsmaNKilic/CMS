<div class="row">
    <div class="col-md-12">
        <h4 class="m-b-lg"><?php echo "<b>$item->title</b> proje kaydını düzenliyorsunuz"; ?></h4>
    </div>
    <div class="col-md-12">
    	<div class="widget">
			<div class="widget-body">
				<form action="<?php echo base_url("project/update/$item->id");?>" method="post" enctype="multipart/form-data">
					...
					<a href="<?php echo base_url("project");?>" class="btn btn-md btn-danger btn-outline">İptal</a>
				</form>
			</div><!-- .widget-body -->
		</div><!-- .widget -->
	</div>
