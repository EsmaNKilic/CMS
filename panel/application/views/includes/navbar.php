...
<nav id="app-navbar" class="navbar navbar-inverse navbar-fixed-top primary">
    ...
    <div class="navbar-header">
        ...
        <a href="<?php echo base_url(); ?>" class="navbar-brand"  style="font-family: 'Zen Tokyo Zoo', cursive;">
            <span class="brand-icon">

                <?php if($settings->logo != "default"){ ?>
                    <img
                        width="50"
                        src="<?php echo get_picture("settings_v", $settings->logo, "150x75"); ?>"
                        alt=""
            ...
            <span class="brand-name" style="position: relative; left: 20px; top:8px;">
    ...
    <div class="navbar-container container-fluid">
        <div class="collapse navbar-collapse" id="app-navbar-collapse">
            <ul class="nav navbar-toolbar navbar-toolbar-left navbar-left">
                ...
                <li>
                    <h5 class="page-title hidden-menubar-top hidden-float">Gösterge Paneli</h5>
                </li>
            </ul>
