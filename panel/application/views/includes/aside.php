                ...
                <div class="avatar avatar-md avatar-circle">
                    <a href="javascript:void(0)">
                        <img class="img-responsive"
                             src="<?php echo base_url("assets"); ?>/assets/images/ml.jpg"
        ...
        <li class="menu-separator"><hr></li>
          ...
          <li>
            ...
            <i class="menu-icon zmdi zmdi-file-text zmdi-hc-lg"></i>
              <span class="menu-text">ProjeSayfası</span>
            </a>
          </li>
          ...
          <li>
            ...
            <span class="menu-text">Galeri İşlemleri</span></a>
          </li>
          ...
          <a href="javascript:void(0)" class="submenu-toggle">
            <i class="menu-icon zmdi zmdi-folder-person zmdi-hc-lg"></i>
