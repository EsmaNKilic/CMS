                    ...
                    <tbody class="sortable" data-url="<?php echo base_url("product/rankSetter");?>">
                        <?php  foreach ($items as $item) { ?>
                            ...
                            <td class="w300">
                                ...
                                <a href="<?php echo base_url("product/update_form/$item->id");?>" class="btn btn-sm btn-success btn-outline"><i class="fa fa-pencil-square-o"></i> Düzenle</a>
                                <a href="<?php echo base_url("product/image_form/$item->id");?>" class="btn btn-sm btn-info btn-outline"><i class="fa fa-image"></i> Resimler</a>
                            </td>
                        </tr>
                        <?php } ?>
                    </tbody>
