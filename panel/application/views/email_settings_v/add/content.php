        ...
        <div class="widget">
            <div class="widget-body">
                <form action="<?php echo base_url("emailsettings/save"); ?>" method="post">
                    ...
                    <div class="form-group">
                        <label>E-poste Sunucu Bilgisi</label>
                        <input class="form-control" placeholder="E-poste Sunucu Bilgisi" name="host" value="<?php echo isset($form_error) ? set_value("host") : ""; ?>">
                        <?php if(isset($form_error)){ ?>
