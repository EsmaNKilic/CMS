                    ...
                    <tbody>
                        ...
                        <?php foreach($items as $item) { ?>
                            ...
                            <tr>
                                ...
                                <td class="text-center w100"><?php echo $item->protocol; ?></td>
                                <td class="text-center w100"><?php echo $item->port; ?></td>
                                <td class="text-center w100"><?php echo $item->user; ?></td>
                                <td class="text-center w100"><?php echo $item->from; ?></td>
                                <td class="text-center w100"><?php echo $item->to; ?></td>
