			...
			<div class="container">
				<div class="header-row flex-column flex-lg-row justify-content-center justify-content-lg-start">
					...
					<div id="logo" class="me-0 me-lg-auto">
						<a href="index.html" class="standard-logo" data-dark-logo="/logo-dark.png"><img src="<?php echo base_url("assets");?>/images/logo.png" alt="Canvas Logo"></a>
						<a href="index.html" class="retina-logo" data-dark-logo="images/logo-dark@2x.png"><img src="<?php echo base_url("assets"); ?>/images/logo@2x.png" alt="Canvas Logo"></a>
					</div><!-- #logo end -->

					<div class="header-misc mb-4 mb-lg-0 d-none d-lg-flex">

						<div class="top-advert">
							<img src="<?php echo base_url("assets"); ?>/images/magazine/ad.jpg" alt="Ad">
						</div>
