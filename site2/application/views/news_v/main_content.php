                    ...
                    <footer class="clearfix">
                        <div class="link pull-right">
                            <ul class="social-links circle small colored clearfix margin-clear text-right animated-effect-1">
                                <li class="twitter">
                                    <a class="share-button" target="_blank" href="https://twitter.com/intent/tweet?text=<?php echo $news->title;?>&url=<?php base_url("haber/$news->url");?>"><i class="fa fa-twitter"></i></a>
                                </li>
                                <li class="facebook">
